...
void plots()
{
    ...
    string histpath = "higher-mass-resonances_all_Gen/hMChists";
    ...
    TH1F *genRap = (TH1F *)f->Get(Form("%s/GenRapidity", histpath.c_str()));
    TH1F *genEta = (TH1F *)f->Get(Form("%s/GenEta", histpath.c_str()));
    ...
    if (GenpT == nullptr || GenMass == nullptr || MC_mult == nullptr || MC_mult_sel == nullptr || recpt1 == nullptr || recpt2 == nullptr || recMass == nullptr || genPhi == nullptr || genRap == nullptr || genEta == nullptr || recPhi == nullptr || recRap == nullptr || recEta == nullptr)
    {
    ...
    vector<TH1F *> hists = {GenMass, MC_mult, MC_mult_sel, recMass, genPhi, genRap, genEta, recPhi, recRap, recEta};
    int counter = 0;
    vector<string> xaxis_names = {"Mass (GeV/c^{2})", "Multiplicity (%)", "Multiplicity (%)", "Mass (GeV/c^{2})", "#phi", "Rapidity", "#eta", "#phi", "Rapidity", "#eta"};
