...
void ALICEResultsMultStrange13TeV()
{
    ...
    vector<pair<int, TString>> tables = {
        ...
        {41, "Kstar_MeanYield"},
        {42, "Phi_MeanYield"},
        {43, "Kstar_KshortRatio"},
        {44, "Phi_KshortRatio"},
        {46, "Phi_PiRatio"},
        {47, "Kstar_KshortRatioPtClass2"},
        {48, "Kstar_KshortRatioPtClass10"},
        {49, "Phi_KshortRatioPtClass2"},
        {50, "Phi_KshortRatioPtClass10"},
        {51, "Kstar_KshortDoubleRatio_Class2by10"},
        {52, "Phi_KshortDoubleRatio_Class2by10"},
        {55, "Kstar_KaRatio"},
        {56, "Kstar_PiRatio"},
        {57, "Phi_KaRatio"},
        {58, "Phi_PrRatio"},
