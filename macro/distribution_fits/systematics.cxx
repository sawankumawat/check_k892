...
void systematics()
{
    ...
    // vector<string> names = {"default", "varA1", "varA2", "varA3", "varA4", "varB1", "varB2", "varC1", "varC2", "varD1", "varD2", "varD3", "varD4"}; // signal extraction
    // vector<string> varNames = {"Fit range", "Normalization range", "Fit function", "Fit parameters"};                                               // signal extraction
    // vector<vector<string>> individual_sources{{"1.05-2.20 GeV/c^{2} (def)", "1.02-2.20 GeV/c^{2}", "1.05-2.30 GeV/c^{2}", "1.08-2.15 GeV/c^{2}", "1.02-2.30 GeV/c^{2}"}, {"2.50-2.60 GeV/c^{2} (def)", "2.40-2.50 GeV/c^{2}", "2.60-2.70 GeV/c^{2}"}, {"Fit 1 (def)", "Fit 2", "Fit 3"}, {"#Gamma fix to PDG (spin-2) (def)", "All parameter free", "#Gamma & M fixed (spin-2)", "#Gamma f_{0}(1710) fix to PDG", "M f_{0} fix to PDG"}};
    ...
    // // ********All sources******************
    int variations[] = {1, 2, 2, 2, 2, 3, 3, 4, 4, 5, 5, 5, 5, 6, 6, 7, 7, 8, 8, 9, 9, 10, 10, 11, 11, 12, 12, 13, 13, 14, 14, 15, 15};
    int variationsNumber[] = {1, 4, 2, 2, 4, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2};
    vector<string> names = {"default", "varA1", "varA2", "varA3", "varA4", "varB1", "varB2", "varC1", "varC2", "varD1", "varD2", "varD3", "varD4", "varTrB1", "varTrB2", "varTrA1", "varTrA2", "varTrC1", "varTrC2", "varTrD1", "varTrD2", "varToA1", "varToA2", "varToB1", "varToB2", "varToC1", "varToC2", "varToD1", "varToD2", "varToE1", "varToE2", "varToF1", "varToF2"}; // All sources
    vector<string> varNames = {"Fit range", "Normalization range", "Fit function", "Fit parameters", "TPC PID", "DCA track to PV", "TPC crossed rows", "TPC RowsClusters", "Cosine PA", "Transverse Radius", "DCA V0 Daughters", "Lifetime", "Competing V0 Rejection", "Ks Mass Window"};                                                                                       // All sources
    ...
    TH1F *hmass_var[size], *hwidth_var[size];
    ...
    l1->SetTextFont(42);
    l1->SetTextSize(0.04);
    l1->SetHeader("Track selection source");
    for (int i = 0; i < size; i++)
    {
    ...
    hwidth_total->GetYaxis()->SetRangeUser(0, 0.301);
    ...
    l2->SetTextFont(42);
    l2->SetTextSize(0.04);
    l2->SetHeader("Track selection source");
    for (int i = 0; i < size; i++)
    {
    ...
    c1->SaveAs("/home/sawan/Music/systematic_mass_TrkSel.png");
    c2->SaveAs("/home/sawan/Music/systematic_width_TrkSel.png");
    ...
    TLegend *l3 = new TLegend(0.30, 0.60, 0.75, 0.91);
    l3->SetFillStyle(0);
    l3->SetBorderSize(0);
    l3->SetTextFont(42);
    l3->SetTextSize(0.06);
    l3->SetHeader("Track selection source");
    for (int i = 0; i < size; i++)
    {
    ...
    c3->SaveAs("/home/sawan/Music/systematic_mass_width_TrkSel.png");
    ...
    for (int i = 0; i < size; i++)
    {
        ...
        cmassvar->SaveAs(Form("/home/sawan/Music/mass_var_PID%d.png", i));
    }
    ...
    for (int i = 0; i < size; i++)
    {
        ...
        cwidthvar->SaveAs(Form("/home/sawan/Music/width_var_PID%d.png", i));
    }
