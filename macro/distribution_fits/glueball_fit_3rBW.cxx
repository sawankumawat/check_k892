...
void glueball_fit_3rBW()
{
    ...
    // TFile *plots_3BW = new TFile("root_files/3rBW_plots_boltzmann.root", "RECREATE");
...
// // Default fitting range is 1.02 to 2.20. Four types of fitting range variations: extend left (1.0), extend right (2.50), large range (1.0 to 2.50), small range (1.05 to 2.15)
        ...
        double parameters[] = {6200, f1270Mass, f1270Width, 7700, f1525Mass, f1525Width, 2500, f1710Mass, f1710Width};
        ...
        // double initial_param_bkg[] = {8.596e5, 0.0419, 3.094, 1.01}; // rotational 1-30 GeV/c (KK channel)
