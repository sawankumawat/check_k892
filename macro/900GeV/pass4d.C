...

{
    ...
    TFile *fInputFile = new TFile("../data/LHC22d_pass4/AnalysisResults.root", "Read"); // Reading the File
    ...
    // for (Int_t ip = 0; ip < 10; ip++)
    {
        ...
        */
        ...
        cinv[ip]->SaveAs(Form("../output/LHC22d_pass4/hfitsig_pt%d.png", ip + 1));
        ...
        if (ResBkg.CompareTo("MIX") == 0)
        {
            ...
            */
            cSigbkg[ip]->SaveAs(Form("../output/LHC22d_pass4/hsigbkg_pt%d.png", ip + 1));
    ...
    hsgnfcance->Draw();
    sig->SaveAs("../output/LHC22d_pass4/significance.png");
    ...
    grchi->Draw("AP");
    t2->DrawLatex(0.28, 0.96, "#bf{K(892)^{0} #rightarrow #pi + K}");
    cgr->SaveAs("../output/LHC22d_pass4/chindfvspt.png");
    // grchi->Write("chils");
    ...
    massleg->Draw("l");
    cgr->SaveAs("../output/LHC22d_pass4/mass_pt.png");
    ...
    // widthleg->Draw("l");
    // cgr->SaveAs("../output/LHC22d_pass4/width_pt.png");
    ...
    legyield->Draw();
    cyield1->SaveAs("../output/LHC22d_pass4/yield1.png");
