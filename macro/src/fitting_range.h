...
const Int_t Npt = 27; // 7 for pbpb and 18 and 21 for pp
...
double lowfitrangeme[40] = {0.75, 0.75, 0.76, 0.76, 0.75, 0.75, 0.73, 0.73, 0.73, 0.75, 0.78, 0.79, 0.79, 0.79, 0.76, 0.78, 0.78, 0.79, 0.75, 0.78, 0.80, 0.75, 0.77, 0.75, 0.74, 0.77, 0.75};
double highfitrangeme[40] = {1.05, 1.04, 1.04, 1.05, 1.05, 1.03, 1.03, 1.05, 1.03, 1.01, 1.00, 1.01, 1.01, 1.03, 1.02, 1.02, 1.04, 1.02, 1.02, 1.01, 0.98, 1.05, 1.08, 1.05, 1.07, 1.08, 1.08};