...
void read_yield_pt_compare()
{
    ...
    string path2 = "/home/sawan/check_k892/output/glueball/LHC22o_pass7_small/435450/KsKs_Channel/higher-mass-resonances/fits/4rBw_fits/pt_dependent/";
    ...
    band1710Mass->SetFillColorAlpha(kBlue, 0.2); // shaded
    band1710Mass->SetLineColor(kBlue);
    ...
    leg1710Mass->AddEntry(hMass1710_1, "f_{0}(1710) Width Free", "pe");
    leg1710Mass->AddEntry(hMass1710_2, "f_{0}(1710) Width Fixed", "pe");
    ...
    leg1710Width->AddEntry(hWidth1710_1, "f_{0}(1710) Width", "pe");
    // leg1710Width->AddEntry(hWidth1710_3, "f_{0}(1710) Width (2022)", "pe");
    band1710Width->SetLineWidth(0);
    leg1710Width->AddEntry(band1710Width, "World-average value", "f");
    leg1710Width->Draw();
    ...
    hYield1525Corrected_1->SetMaximum(0.013);
    hYield1525Corrected_1->SetMinimum(5e-8);
    ...
    legYield->AddEntry(hYield1525Corrected_1, "f_{0}(1710) Width Free", "pe");
    legYield->AddEntry(hYield1525Corrected_2, "f_{0}(1710) Width Fixed", "pe");
    ...
    hYield1710Corrected_1->SetMarkerStyle(20);
    hYield1710Corrected_1->SetMaximum(0.01);
    hYield1710Corrected_1->SetMinimum(5e-8);
    ...
    TF1 *fitFcn_temp3 = new TF1("fitfunc_temp3", FuncLavy, 0.0, 15.0, 4);
    ...
    legYieldRatio->AddEntry(hYieldRatio_1, "f_{0}(1710) Width Free", "pe");
    legYieldRatio->AddEntry(hYieldRatio_2, "f_{0}(1710) Width Fixed", "pe");
    ...
    legRawYieldf2->AddEntry(hYield1525Raw_1, "f_{0} width free", "pe");
    legRawYieldf2->AddEntry(hYield1525Raw_2, "f_{0} width fixed", "pe");
    legRawYieldf2->Draw();
    ...
    TH1F *hRawYieldRatio = (TH1F *)hYield1710Raw_1->Clone("hRawYieldRatio");
    hRawYieldRatio->Divide(hYield1710Raw_2);
    hRawYieldRatio->SetMarkerStyle(20);
    hRawYieldRatio->SetMaximum(1.9);
    hRawYieldRatio->SetMinimum(0.3);
    hRawYieldRatio->SetLineColor(kRed);
    hRawYieldRatio->SetMarkerColor(kRed);
    hRawYieldRatio->GetYaxis()->SetTitle("Raw yield ratio");
    hRawYieldRatio->Draw("pe");
    TLegend *legRawYieldRatio = new TLegend(0.55, 0.75, 0.85, 0.93);
    legRawYieldRatio->SetBorderSize(0);
    legRawYieldRatio->SetFillStyle(0);
    legRawYieldRatio->SetTextSize(0.03);
    legRawYieldRatio->SetHeader("pp #sqrt{#it{s}} = 13.6 TeV");
    legRawYieldRatio->AddEntry(hRawYieldRatio, "f_{0}(1710) Width Free / Fixed", "pe");
    legRawYieldRatio->Draw();
    ...
    int f2_marker2 = 29;     // hollow circle marker
    int f2_marker3 = 24;     // star marker
    ...
    TMarker *marker_f0_2 = new TMarker(f0_mass, f0_meanpt_2, f0_marker2);
