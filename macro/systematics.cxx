...
void systematics()
{
    ...
    for (int imult = 0; imult < nmultbins; imult++)
    {
        ...
        {
            openTFile(fmultEstVars[i], basePathPIDAndMultEst + multEstVars[i] + "/hInvMass/corrected_spectra_0_100.root");
        ...
        TH1D *hRelUncertMultEstVars = operations.RelativeUncertainty(hSpectraDefault0100, MultEstVariationHists);
