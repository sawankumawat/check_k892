...
void yield_compare()
{
    ...
    TFile *spectra = new TFile("/Users/blim/cernbox/SWAN_projects/resonances/K892/output/LHC22o_pass6_small_TPC2TOF3Cut/common/spectra_1_0.root", "READ");
    ...
    TF1 *fLevyTsallis = new TF1("levyTsallis", levyTsallis, 0, 13, 3); // Adjust range and parameter count as needed
    ...
    c1->SaveAs("yield_compare_TOF_TPC_tune.png");
}