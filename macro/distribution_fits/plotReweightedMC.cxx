...
void plotReweightedMC()
{
    ...
    TLegend *leg = new TLegend(0.15, 0.72, 0.55, 0.93);
    ...
    cCorrectedf0Fit->SaveAs((savePath + "/LevyFitf0_reweighted.png").c_str());
    ...
    // Create legend with physics information
    TLegend *leg2 = new TLegend(0.15, 0.72, 0.55, 0.93);
    ...
    legend5->Draw();
    cMeanPt->SaveAs((savePath + "/MeanPt_vs_Mass_rebated.png").c_str());
    ...
    */
    ...
    if (otherQAPlots)
    {
        ...
        cNewEfficiency->SaveAs((savePath + "/EfficiencyComparisonf0.png").c_str());
        ...
        cNewEfficiency2->SaveAs((savePath + "/EfficiencyComparisonf2.png").c_str());
        ...
        cYieldCompare->SaveAs((savePath + "/CorrectedYieldComparisonf0.png").c_str());
    }
}
