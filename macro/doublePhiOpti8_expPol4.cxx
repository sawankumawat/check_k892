...
void doublePhiOpti8_expPol4()
{
    ...
    TF1 *fitBkg = new TF1("fitBkg", expPol3, FIT_MIN, FIT_MAX, 5);
    fitBkg->SetParNames("p0", "p1", "p2", "p3", "p4");
    fitBkg->SetParameters(-2.7e2, 64.0, 40.0, -6.5, 0.0);
    ...
    TF1 *fInitialCombinedFit = new TF1("fInitialCombinedFit", BWExpol, FIT_MIN, FIT_MAX, 8);
    fInitialCombinedFit->SetParNames("SignalYield", "Mass", "Width", "p0", "p1", "p2", "p3", "p4");
    ...
    fInitialCombinedFit->SetParameter(7, fitBkg->GetParameter(4));
    ...
    TF1 *fitFunc = new TF1("fitFunc", BWExpol, FIT_MIN, FIT_MAX, 8);
    fitFunc->SetParNames("SignalYield", "Mass", "Width", "p0", "p1", "p2", "p3", "p4");
    ...
    //============================================================
    TF1 *fitBOnly = new TF1("fitBOnly", expPol3, FIT_MIN, FIT_MAX, 5);
    fitBOnly->SetParNames("p0", "p1", "p2", "p3", "p4");
    fitBOnly->SetParameters(fInitialCombinedFit->GetParameter(3), fInitialCombinedFit->GetParameter(4), fInitialCombinedFit->GetParameter(5), fInitialCombinedFit->GetParameter(6), fInitialCombinedFit->GetParameter(7));
    ...
    TF1 *fitBkgFinal = new TF1("fitBkgFinal", expPol3, FIT_MIN, FIT_MAX, 5);

    fitBkgFinal->SetParameters(fitFunc->GetParameter(3), fitFunc->GetParameter(4), fitFunc->GetParameter(5), fitFunc->GetParameter(6), fitFunc->GetParameter(7));
    ...
    cout << "bkg p0 " << fitBkgFinal->GetParameter(0) << " p1 " << fitBkgFinal->GetParameter(1) << " p2 " << fitBkgFinal->GetParameter(2) << endl;
    ...
    legend->AddEntry(fitFunc, "BW + expol4", "l");
    legend->AddEntry(fitBkgFinal, "expol4 (bkg.)", "l");
    legend->AddEntry(fitSignal, "Breit-Wigner (signal)", "l");
    legend->Draw();
    ...
    cInvMass->SaveAs(savepath + "/InvariantMassWithFit_expPol4.png");
}
