...
void compare_signal_plots()
{
    ...
    // leg->AddEntry(h1, "4 MeV/c^{2}", "lpe");
    // leg->AddEntry(h2, "5 MeV/c^{2}", "lpe");
    // leg->AddEntry(h3, "6 MeV/c^{2}", "lpe");
    ...
    // // leg2->AddEntry(hbkg1, "4 MeV/c^{2}", "lpe");
    // // leg2->AddEntry(hbkg2, "5 MeV/c^{2}", "lpe");
    // // leg2->AddEntry(hbkg3, "6 MeV/c^{2}", "lpe");
    // leg2->Draw("same");
