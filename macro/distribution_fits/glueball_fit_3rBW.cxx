...
void glueball_fit_3rBW()
{
    ...
    // TFile *f = new TFile("/home/sawan/check_k892/output/glueball/LHC22o_pass7_small/260782/KsKs_Channel/strangeness_tutorial/hglue_MIX_norm_2.50_2.60..root", "READ");
    ...
    // TF1 *BEexpol = new TF1("BEexpol", BWsum_expol3_hera, 1.02, 2.20, 13); // expol 3
    ...
    // BEexpol->FixParameter(size_fitparams + 0, 5.562e5);  // expol 3  // 710000  // 5.562e5
    // BEexpol->SetParameter(size_fitparams + 1, -0.09379); // expol 3  // -0.03  // -0.09379
    // BEexpol->FixParameter(size_fitparams + 2, 2.569);    // expol 3  // 2.78  // 2.569
    // BEexpol->SetParameter(size_fitparams + 3, 1.098);    // expol 3  // 1.15  // 1.098
    ...
    TF1 *BEexpol = new TF1("BEexpol", BWsum_boltzman_1, 1.02, 2.20, 12); // expol 3
    ...
    // double parameters[] = {100, f1270Mass, f1270Width, 100, f1525Mass, f1525Width, 50, f1710Mass, f1710Width};
    double parameters[] = {6998, f1270Mass, f1270Width, 7128, f1525Mass, f1525Width, 4058, f1710Mass, f1710Width};
    int size_fitparams = sizeof(parameters) / sizeof(parameters[0]);
    ...
    BEexpol->FixParameter(size_fitparams + 1, 0.6456);  // expol 3  //  0.6456  // -0.09379
