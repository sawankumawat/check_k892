...
Double_t signalPlusBackground(Double_t *x, Double_t *par)
{
...
void doublePhiSimpleOpti5Likelihood()
{
    gStyle->SetOptFit(0);
    gStyle->SetOptStat(0);
    ////======Pair=========
    ...
    TF1 *fitFunc = new TF1("fitFunc", signalPlusBackground, FIT_MIN, FIT_MAX, 7);
