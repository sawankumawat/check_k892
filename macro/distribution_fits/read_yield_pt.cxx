...
void read_yield_pt()
{
    ...
    for (int i = 0; i < nBins; i++)
    {
        ...
        if (genYieldf0 > 0)
        {
            hefficiencyf0->SetBinContent(i + 2, recYieldf0 / genYieldf0);
            hefficiencyf0->SetBinError(i + 2, recYieldError);
        }
        ...
        if (efficiencyf2 > 0)
        {
            hefficiencyf2->SetBinContent(i + 2, recYieldf2 / efficiencyf2);
            hefficiencyf2->SetBinError(i + 2, recYieldErrorf2);
        }
    }
    ...
    for (int i = 0; i < nBins; i++)
    {
        ...
        double eff1525_err = hefficiencyf2->GetBinError(i + 2);
    ...
    gMeanPtvsMassMesons->SetMarkerColor(0); // invisible marker
    gMeanPtvsMassMesons->SetLineColor(kBlack);
    ...
    gMeanPtvsMassMesons->GetYaxis()->SetTitleOffset(1.6);
    gMeanPtvsMassMesons->SetMinimum(0.0);
    gMeanPtvsMassMesons->SetMaximum(2.95);
    gMeanPtvsMassMesons->GetXaxis()->SetLimits(0.0, 1.8);
    ...
    legend4->AddEntry(gMeanPtvsMassMesons, "Light flavour hadrons (13 TeV)", "p");
