...
void compare_PIDnSigmaDataMC()
{
    ...
    int integralBinLow = h1DNsigmaTPCKaon_pt->FindBin(-1.5 + 0.001);
    int integralBinHigh = h1DNsigmaTPCKaon_pt->FindBin(1.5 - 0.001);
    ...
    h1DNsigmaTPCPion_pt->GetYaxis()->SetTitle("Normalized counts");
    h1DNsigmaTPCPion_pt->GetXaxis()->SetRangeUser(-2, 2);
    h1DNsigmaTPCPion_pt->Scale(1.0 / h1DNsigmaTPCPion_pt->Integral(integralBinLow, integralBinHigh));
    h1DNsigmaTPCPion_pt->SetMaximum(h1DNsigmaTPCPion_pt->GetMaximum() * 1.3);
    ...
    h1DNsigmaTPCPionMC_pt->Scale(1.0 / h1DNsigmaTPCPionMC_pt->Integral(integralBinLow, integralBinHigh));
    ...
    latex->DrawLatex(0.22, 0.85, "pp, #sqrt{#it{s}} = 13.6 TeV");
    latex->DrawLatex(0.22, 0.8, Form("%.1f < #it{p}_{T} < %.1f GeV/#it{c}", lowpT, highpT));
    latex->DrawLatex(0.22, 0.75, "FT0M: 0-100%");
    ...
    h1DNsigmaTPCKaon_pt->GetYaxis()->SetTitle("Normalized counts");
    h1DNsigmaTPCKaon_pt->GetXaxis()->SetRangeUser(-2, 2);
    h1DNsigmaTPCKaon_pt->Scale(1.0 / h1DNsigmaTPCKaon_pt->Integral(integralBinLow, integralBinHigh));
    h1DNsigmaTPCKaon_pt->SetMaximum(h1DNsigmaTPCKaon_pt->GetMaximum() * 1.3);
    ...
    h1DNsigmaTPCKaonMC_pt->Scale(1.0 / h1DNsigmaTPCKaonMC_pt->Integral(integralBinLow, integralBinHigh));
    ...
    h1DNsigmaTOFPion_pt->GetYaxis()->SetTitle("Normalized counts");
    h1DNsigmaTOFPion_pt->Scale(1.0 / h1DNsigmaTOFPion_pt->Integral(integralBinLow, integralBinHigh));
    h1DNsigmaTOFPion_pt->SetMaximum(h1DNsigmaTOFPion_pt->GetMaximum() * 1.3);
    ...
    h1DNsigmaTOFPionMC_pt->Scale(1.0 / h1DNsigmaTOFPionMC_pt->Integral(integralBinLow, integralBinHigh));
    ...
    h1DNsigmaTOFKaon_pt->GetYaxis()->SetTitle("Normalized counts");
    h1DNsigmaTOFKaon_pt->GetXaxis()->SetRangeUser(-2, 2);
    h1DNsigmaTOFKaon_pt->Scale(1.0 / h1DNsigmaTOFKaon_pt->Integral(integralBinLow, integralBinHigh));
    h1DNsigmaTOFKaon_pt->SetMaximum(h1DNsigmaTOFKaon_pt->GetMaximum() * 1.3);
    ...
    h1DNsigmaTOFKaonMC_pt->Scale(1.0 / h1DNsigmaTOFKaonMC_pt->Integral(integralBinLow, integralBinHigh));
