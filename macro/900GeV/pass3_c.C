...

{
    ...
    double lowfitrangels[Npt] = {0.735, 0.73, 0.74, 0.755, 0.76, 0.78, 0.79, 0.79, 0.79, 0.79, 0.795, 0.795, 0.79};

    double highfitrangels[Npt] = {1.2, 1.2, 1.2, 1.18, 1.10, 1.2, 1.12, 1.14, 1.1, 1.12, 1.16, 1.18, 1.1};
    ...
    TFile *fInputFile = new TFile("../data/set2_900GeV/LHC22c_pass3/AnalysisResults.root", "Read"); // Reading the File
    ...
    Double_t Event = 2.523591e7; // In the root file it is hCounterAcc
    //*************************************************************************************************************************
    ...
    // for (Int_t ip = 0; ip < 10; ip++)
    {
        ...
        */
        ...
        cinv[ip]->SaveAs(Form("../output/set2_900GeV/LHC22c_pass3/hfitsig_pt%d.png", ip + 1));
        ...
        if (ResBkg.CompareTo("MIX") == 0)
        {
            ...
            */
            cSigbkg[ip]->SaveAs(Form("../output/set2_900GeV/LHC22c_pass3/hsigbkg_pt%d.png", ip + 1));
    ...
    hsgnfcance->Draw();
    sig->SaveAs("../output/set2_900GeV/LHC22c_pass3/significance.png");
    ...
    grchi->Draw("AP");
    t2->DrawLatex(0.28, 0.96, "#bf{K(892)^{0} #rightarrow #pi + K}");
    cgr->SaveAs("../output/set2_900GeV/LHC22c_pass3/chindfvspt.png");
    // grchi->Write("chils");
    ...
    massleg->Draw("l");
    cgr->SaveAs("../output/set2_900GeV/LHC22c_pass3/mass_pt.png");
    ...
    // widthleg->Draw("l");
    // cgr->SaveAs("../output/set2_900GeV/LHC22c_pass3/width_pt.png");
    ...
    legyield->Draw();
    cyield1->SaveAs("../output/set2_900GeV/LHC22c_pass3/yield1.png");
