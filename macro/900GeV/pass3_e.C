...

{
    ...
    double lowfitrangeme[Npt + 1] = {0.8, 0.66, 0.65, 0.68, 0.68, 0.70, 0.71, 0.73, 0.75, 0.74, 0.74, 0.74};

    double highfitrangeme[Npt + 1] = {1.15, 1.18, 1.20, 1.15, 1.12, 1.03, 1.05, 1.20, 1.2, 1.14, 1.2};

    // For LS free width (pol3)
    double lowfitrangels[Npt] = {0.79, 0.735, 0.74, 0.755, 0.76, 0.78, 0.79, 0.79, 0.79, 0.79, 0.795, 0.795, 0.79};

    double highfitrangels[Npt] = {1.3, 1.2, 1.2, 1.18, 1.10, 1.2, 1.12, 1.14, 1.1, 1.2, 1.16, 1.3, 1.1};
    ...
    TFile *fInputFile = new TFile("../data/set2_900GeV/LHC22e_pass3/AnalysisResults.root", "Read"); // Reading the File
    ...
    Double_t Event = 5.851367e7; // In the root file it is hCounterAcc
    //*************************************************************************************************************************
    ...
    // for (Int_t ip = 0; ip < 10; ip++)
    {
        ...
        */
        ...
        cinv[ip]->SaveAs(Form("../output/set2_900GeV/LHC22e_pass3/hfitsig_pt%d.png", ip + 1));
        ...
        if (ResBkg.CompareTo("MIX") == 0)
        {
            ...
            */
            cSigbkg[ip]->SaveAs(Form("../output/set2_900GeV/LHC22e_pass3/hsigbkg_pt%d.png", ip + 1));
    ...
    hsgnfcance->Draw();
    sig->SaveAs("../output/set2_900GeV/LHC22e_pass3/significance.png");
    ...
    grchi->Draw("AP");
    t2->DrawLatex(0.28, 0.96, "#bf{K(892)^{0} #rightarrow #pi + K}");
    cgr->SaveAs("../output/set2_900GeV/LHC22e_pass3/chindfvspt.png");
    // grchi->Write("chils");
    ...
    massleg->Draw("l");
    cgr->SaveAs("../output/set2_900GeV/LHC22e_pass3/mass_pt.png");
    ...
    // widthleg->Draw("l");
    // cgr->SaveAs("../output/set2_900GeV/LHC22e_pass3/width_pt.png");
    ...
    legyield->Draw();
    cyield1->SaveAs("../output/set2_900GeV/LHC22e_pass3/yield1.png");
