...
void systematics2()
{
    ...
    // int variationsNumber[] = {1, 4, 2, 3, 4};
    // // Number of variations for each source
    // vector<string> names = {"default", "varA1", "varA2", "varA3", "varA4", "varB1", "varB2", "varC1", "varC2", "varC3", "varD1", "varD2", "varD3", "varD4"}; // signal extraction
    // vector<string> varNames = {"Fit range", "Normalization range", "Fit function", "Fit parameters"};                                                                 // signal extraction
    // vector<vector<string>> individual_sources{{"1.05-2.20 GeV/c^{2} (def)", "1.02-2.20 GeV/c^{2}", "1.05-2.30 GeV/c^{2}", "1.08-2.15 GeV/c^{2}", "1.02-2.30 GeV/c^{2}"}, {"2.50-2.60 GeV/c^{2} (def)", "2.40-2.50 GeV/c^{2}", "2.60-2.70 GeV/c^{2}"}, {"Fit 1 (def)", "Fit 2", "Fit 3", "Fit 4"}, {"#Gamma fix to PDG (spin-2) (def)", "All parameter free", "#Gamma & M fixed (spin-2)", "#Gamma f_{0}(1710) fix to PDG", "M f_{0} fix to PDG"}};
    ...
    // // // ********All sources******************
    // int variations[] = {1, 2, 2, 2, 2, 3, 3, 4, 4, 4, 5, 5, 5, 5, 6, 6, 7, 7, 8, 8, 9, 9, 10, 10, 11, 11, 12, 12, 13, 13, 14, 14, 15, 15};
    // int variationsNumber[] = {1, 4, 2, 3, 4, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2};
    // vector<string> names = {"default", "varA1", "varA2", "varA3", "varA4", "varB1", "varB2", "varC1", "varC2", "varC3", "varD1", "varD2", "varD3", "varD4", "varTrB1", "varTrB2", "varTrA1", "varTrA2", "varTrC1", "varTrC2", "varTrD1", "varTrD2", "varToA1", "varToA2", "varToB1", "varToB2", "varToC1", "varToC2", "varToD1", "varToD2", "varToE1", "varToE2", "varToF1", "varToF2"}; // All sources
    ...
    // vector<vector<string>> individual_sources{{"1.05-2.20 GeV/c^{2} (def)", "1.02-2.20 GeV/c^{2}", "1.05-2.30 GeV/c^{2}", "1.08-2.15 GeV/c^{2}", "1.02-2.30 GeV/c^{2}"}, {"2.50-2.60 GeV/c^{2} (def)", "2.40-2.50 GeV/c^{2}", "2.60-2.70 GeV/c^{2}"}, {"Fit 1 (def)", "Fit 2", "Fit 3", "Fit 4"}, {"#Gamma fix to PDG (spin-2) (def)", "All parameter free", "#Gamma & M fixed (spin-2)", "#Gamma f_{0}(1710) fix to PDG", "M f_{0} fix to PDG"}, {"3#sigma (def)", "4#sigma", "5#sigma"}, {"0.05 cm (def)", "0.04 cm", "0.06 cm"}, {"70 (def)", "100", "120"}, {"0.8 (def)", "0.9", "1.0"}, {"0.97 (def)", "0.95", "0.99"}, {"0.5 cm (def)", "0.4 cm", "0.6 cm"}, {"0.5 cm (def)", "0.3 cm", "1.0 cm"}, {"20 cm (def)", "15 cm", "25 cm"}, {"5 MeV (def)", "4", "6"}, {"3#sigma (def)", "4#sigma", "5#sigma"}}; // All sources
    ...
    for (int i = 0; i < size; i++)
    {
        ...
        hmass_var[i]->GetYaxis()->SetRangeUser(0.0, 0.0029);
    ...
    hwidth_total->GetYaxis()->SetRangeUser(0.00, 0.131);
