...
void EPOS_modified()
{
    ...
    for (int i = 0; i < 10; i++)
    {
        cout << "bin " << i
             ...
             << "  phi=" << phiYield[i]
             << "  kstar=" << kstarYield[i]
             << "  kshort=" << kshortYield[i]
             << "  proton=" << protonYield[i]
             << "  pion=" << pionYield[i]
             << "  kaon=" << kaonYield[i]
             << "  XiStar=" << XiStarYield[i]
             << "  ChargedKstar=" << ChargedKstarYield[i]
             << endl;
    }
