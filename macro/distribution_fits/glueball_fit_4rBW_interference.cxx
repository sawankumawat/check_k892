...
void glueball_fit_4rBW_interference()
{
    ofstream file;
...
// // // Default fitting range is 1.02 to 2.20. Four types of fitting range variations: extend left (1.0), extend right (2.50), large range (1.0 to 2.50), small range (1.05 to 2.15)
        ...
        vector<vector<float>> par_limits = {{0, 2 * f1270Width}, {1, 10 * f1270WidthErr}, {4, 5 * f1525Width}, {5, 10 * f1525WidthErr}, {6, 2 * f1525Width}, {7, 20 * f1710WidthErr}};
        ...
        singlefits->SetParameter(0, obtained_parameters[9]);
        ...
        TLegend *ltemp = new TLegend(0.20, 0.65, 0.40, 0.87);
        ltemp->SetFillStyle(0);
        ...
        ltemp->AddEntry(BEexpol, "Coherent sum + Residual BG", "l");
        ...
        ltemp->AddEntry(onlyBW, "Coherent sum", "l");
        ltemp->Draw("same");
        ...
        vector<vector<float>> par_limits = {{0, 2 * f1270Width}, {1, 15 * f1270WidthErr}, {4, 5 * f1525Width}, {5, 10 * f1525WidthErr}, {6, 2 * f1525Width}, {7, 20 * f1710WidthErr}};
        ...
        double fitmass1270_err = BEexpol->GetParError(0);
        double fitwidth1270 = BEexpol->GetParameter(1);
        double fitwidth1270_err = BEexpol->GetParError(1);
        double fitmass1320 = BEexpol->GetParameter(2);
        double fitmass1320_err = BEexpol->GetParError(2);
        double fitwidth1320 = BEexpol->GetParameter(3);
        double fitwidth1320_err = BEexpol->GetParError(3);
        ...
        double fitmass1710 = BEexpol->GetParameter(6);
